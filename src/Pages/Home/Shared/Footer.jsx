...
import logo from '../../../assets/image/collegeLogo.jpg'
    ...
    return (
      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4">
        <div className="flex items-center mb-4 lg:mb-0">
          ...
          <h2 className="text-white text-xl font-bold">College Hunts</h2>
        </div>
      ...
      <div className="container mx-auto text-center mt-12">
        <p className="text-gray-400">&copy; {new Date().getFullYear()} College Hunts. All rights reserved.</p>
      </div>
    </footer>
    );
};
